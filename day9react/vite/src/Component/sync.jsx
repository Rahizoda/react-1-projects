...
const Sync = ({ data, deleteUser, EditUser , SearchUser ,  AddUser , Checked , SelectUsers }) => {
  ...
  return (
    <>
      ...
      <h1 style={{ textAlign: 'center', margin: '20px 0', font:'bold 24px' }}>List User</h1>

      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 5px', backgroundColor: 'white' }}>
        <div>
      ...
      <table style={{  borderCollapse: 'collapse', width: '100%', margin:'auto' }} >
        <thead style={{  fontSize:'25px',  color:'white' , textAlign: 'center',  border: '2px solid gray', padding: '10px' }}>
          <th style={{ padding: '10px', border: '1px solid gray' }} >ID</th>
          <th style={{ padding: '10px', border: '1px solid gray' }} >Name</th>
          <th style={{ padding: '10px', border: '1px solid gray' }} >Age</th>
